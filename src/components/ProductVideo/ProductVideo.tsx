		...
		<section className={styles.ProductVideo}>
			<div className={styles.ProductVideo__video}>
				<video
					onClick={onStop}
					ref={videoRef}
					poster="/img/Product/preview.jpg">
				...
				{play === false && (
					<button
						className={`btn-reset ${styles.ProductVideo__play}`}
						onClick={onPlay}>
						<svg
							...
							fill="none">
							<path
								d="M1.53688 0.978013C0.871153 0.55437 0 1.03258 0 1.82167V12.1783C0 12.9674 0.87115 
