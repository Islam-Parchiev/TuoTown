		...
		<header className={styles.header}>
			<div className={`container ${styles.header__container}`}>
				 <div className={styles.header__column}>
					<button className={`btn-reset ${styles.header__sidebar}`}>
					...
					<button className={`btn-reset ${styles.header__position}`}>
						<svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M20.125 9.58333C20.125 16.2917 11.5 22.0417 11.5 22.0417C11.5 
									...
									9.58333Z" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
							<path d="M11.5 12.4583C13.0878 12.4583 14.375 11.1711 14.375 9.58333C14.375 7.99551 
									...
									11.1711 9.91218 12.4583 11.5 12.4583Z" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
				 ...
				 <div className={styles.header__column}>
					<button className={`btn-reset ${styles.header__basket}`}>
						<svg width="19" height="23" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
							<g opacity="0.3" clip-path="url(#clip0_67_4242)">
					...
					<button className={`btn-reset ${styles.header__mail}`}>
						<svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M4.38175 3.83333H19.7151C20.7693 3.83333 21.6318 4.69583 21.6318 5.74999V17.25C21.6318 
								...
								17.25V5.74999C2.46509 4.69583 3.32759 3.83333 4.38175 3.83333Z" stroke="white" stroke-width="1.3" 
					...
					<button className={`btn-reset ${styles.header__search}`}>
						<svg width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							11.09 18.2083Z" stroke="white" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
