	...
	return (
		<section className={styles.Specifications}>
				...
				<div className={styles.Specifications__info}>
					...
					<button className={`btn-reset ${styles.Specifications__more_btn}`}>
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M12.4979 4.5C12.4979 4.22386 12.274 4 
								...
								11.4979H12.4979V4.5Z" fill="#ADACAC"/>
						</svg>
