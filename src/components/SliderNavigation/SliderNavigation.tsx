	...
	return (
		<div className="SliderNavigation">
			<button
				...
				className="btn-reset slider-prev">
				<svg
					width="16"
					height="8"
					viewBox="0 0 16 8"
					...
					<path
						d="M0.646447 3.64645C0.451184 3.84171 0.451184 4.15829 0.646447 4.35355L3.82843 
					...
					0.464466C4.34027 0.269204 4.02369 0.269204 3.82843 0.464466L0.646447 3.64645ZM1 4.5H16V3.5H1V4.5Z"
					/>
				</svg>
			</button>
			<button
				onClick={() => swiper.slideNext()}
				className="btn-reset slider-next">
				<svg
					width="16"
					height="8"
					viewBox="0 0 16 8"
					...
					xmlns="http://www.w3.org/2000/svg">
					<path
						d="M15.3536 4.35355C15.5488 4.15829 15.5488 3.84171 15.3536 3.64645L12.1716 
					...
					7.53553L15.3536 4.35355ZM0 4.5H15V3.5H0V4.5Z"
					/>
				</svg>
			</button>
		</div>
